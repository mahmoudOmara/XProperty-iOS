...
- (void)initLayer {
    ...
    _itemFontSize = 12.0;
    _itemsFont = [UIFont systemFontOfSize:12.0];
    _DirectionDown = YES;
}
...
//
    if(label == nil){
        label = [[UILabel alloc] initWithFrame:CGRectMake(8, 0, self.frame.size.width, self.frame.size.height)];
